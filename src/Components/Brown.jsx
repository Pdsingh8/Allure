    ...
    <div className="bg-yellow-950 w-full  md:h-[300vh] relative">
      ...
      <div className="flex flex-col space-y-8 p-4">
        <div className=" w-full flex justify-end ">
          <img src="src/assets/b1.jpg" alt="" className=" "/>
        </div>
        <div className="w-full flex justify-start">
          <img src="src/assets/b2.jpg" alt="" className=" ml-4 " />
        </div>
        <div className="w-full">
          <img src="src/assets/b3.jpg" alt="" className=" w-100 h-130 float-right" />
        </div>
        <div className="w-full flex justify-start">
          <img src="src/assets/b4.jpg" alt="" className="w-100 h-130" />
        </div>
      </div>
    </div>
  );
