...
function NewLook() {
  ...
  const ProductModal = ({ product, onClose }) => (
    <div className="absolute flex bg-white p-4 shadow-lg h-48 w-50 md:w-126 ml-6 z-50 animate-slide-down transition-all duration-0 ease-out mt-4  ">
      <button
        onClick={onClose}
  ...
  return (
    <div className="relative w-[300px] md:w-full h-screen ">
      ...
      <div className="relative w-[300px] md:w-full h-[200px] md:h-[350px]">
        <img
          ...
          alt=""
          className="object-cover w-full md:h-180"
        />
        ...
        <div className="absolute w-[300px] md:w-full h-screen inset-0 flex text-center items-center justify-center">
          <StaticButton
            className="w-13 h-13 rounded-full top-[40%] mr-20 absolute z-20 hover:rounded-full hover:text-xs"
            onClick={() => {
          ...
          <StaticButton
            className="w-13 h-13 rounded-full top-[68%] mr-25 absolute"
            onClick={() => {
          ...
          <StaticButton
            className="w-13 h-13 p-3 rounded-full top-[80%] mr-2 absolute"
            onClick={() => {
