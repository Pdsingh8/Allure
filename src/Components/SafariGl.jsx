...
function SafariGl() {
  ...
  return (
    // main-div
    <div
      className=" flex flex-col md:flex-row justify-around  mt-5 w-full h-[160vh] md:h-[162vh] overflow-hidden"
      onWheel={handleWheel}
    ...
    >
      ...
      <div className="hidden sm:block justify-evenly ml-7 items-center ">
        <img
          ...
          alt=""
          className="w-160 h-250 object-cover "
        />
      </div>
      {/* second-div */}
      {/* scroller-div */}
      <div
        className="hidden sm:block overflow-y-auto scrollbar-none mr-3 gap-3 md:flex flex-col ml-3 items-center inset-0 w-120"
        ref={scrollerRef}
      >
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className={`p-2 border-2 mr-4 rounded ${currentIndex === 0
                ...
                <button
                  ...
                  className={`p-2 border-2 mr-4 rounded ${currentIndex === products.length - 1
                      ? "border-gray-200 text-gray-300 cursor-not-allowed"
                      : "border-gray-400 hover:border-gray-600 hover:text-gray-800"
                    }`}
                >
