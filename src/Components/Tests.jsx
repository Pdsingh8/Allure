...
const Tests = () => {
  ...
  const images = [
    { src: "/assets/s1.jpg", caption: "My First Image" },
    { src: "/assets/s2.jpg", caption: "Another cool pic" },
    { src: "/assets/s3.jpg", caption: "Vacation vibes" },
    { src: "/assets/s4.jpg", caption: "Work in progress" },
    { src: "/assets/s5.jpg", caption: "Chill scene" },
    { src: "/assets/s6.jpg", caption: "Evening lights" },
    { src: "/assets/s7.jpg", caption: "Nature beauty" },
    { src: "/assets/s8.jpg", caption: "Final shot" },
  ];
  ...
  useEffect(() => {
    ...
    if (!container || !imageScroll || !description) return;

    const imageHeight = 400; // Height of each image
    const totalScrollDistance = imageHeight * (images.length - 1);
    const descriptionJoinPoint = imageHeight * 5;
      ...
      gsap.timeline({
        scrollTrigger: {
          ...
          onUpdate: (self) => {
            ...
            const scrolled = progress * totalScrollDistance;

            if (scrolled <= descriptionJoinPoint) {
              gsap.set(imageScroll, { y: -scrolled });
              gsap.set(description, { y: 0 });
            } else {
              const remainingScroll = scrolled - descriptionJoinPoint;
              gsap.set(imageScroll, {
                y: -(descriptionJoinPoint + remainingScroll),
              });
              gsap.set(description, { y: -remainingScroll });
            }
          },
        },
      });
    ...
    <div className="min-h-screen">
      ...
      <div ref={containerRef} className="h-screen overflow-hidden">
        <div className="flex h-full">
          {/*  Static image */}
          <div className="w-1/3 bg-blue-100 flex items-center justify-center ml-10">
          ...
          {/*   Description */}
          <div className="w-2/5 ml-4  relative overflow-hidden">
            <div ref={descriptionRef} className="p-8">
              ...
              <p className="text-gray-600 text-[15px] font-sans">
                Introduce a touch of timeless sophistication to your wardrobe
                with our impeccably crafted dark beige suit. Designed for the
                discerning gentleman, this suit showcases a classic notch lapel
                and a sleek two-button front closure. Thoughtfully designed flap
                pockets at the waist and a chest pocket on the left side add
                both functionality and elegance. The jacket, featuring
                structured shoulders and a tailored fit, enhances your physique,
                providing a contemporary and polished appearance. The rich camel
                colour exudes versatility and style, making it suitable for
                various occasions. The pleated trousers add a touch of classic
                elegance and comfort. Made with fine craftsmanship, every stitch
                is carefully executed to ensure durability and a luxurious feel.
                Whether for professional settings, weddings, or special events,
                this suit represents high-end fashion and impeccable design. Add
                this distinguished suit to your collection and make a lasting
                impression.
              </p>
              <p className="flex flex-col space-y-2 text-gray-600 text-[14px] font-sans">
                The jacket features:
              ...
              <div className="space-y-6 text-gray-600">
                ...
                <div className="">
                  <p className="text-black">
                    $1,426.00 Regular price $1,551.00
                  </p>
                  <p>tax included</p>
                  <p>quantity :</p>
                  <div className="border border-gray-300 w-55 h-13 flex justify-evenly items-center ">
                    ...
                    <input type="text" value={count} className="w-5" onChange={(e) => setCount(Number(e.target.value))} />
                    <button
                      onClick={increase}
                ...
                <div className="flex flex-col ">
                  <button className="relative w-120 cursor-pointer px-6 py-2 bg-black text-white text-[16px] group overflow-hidden rounded">
                  ...
                  <button className="relative overflow-hidden border w-120 mt-2 border-black px-6 py-3 text-black bg-white  transition-colors duration-300 group">
